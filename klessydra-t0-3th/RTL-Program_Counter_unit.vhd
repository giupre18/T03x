...
entity Program_Counter is
  ...
  port (
    ...
    served_if_except_condition        : out std_logic_vector(THREAD_POOL_SIZE-1 downto 0);
...
architecture PC of Program_counter is
  ...
  signal if_except_condition_replicated        : std_logic_vector(harc_range);
  ...
  signal served_if_except_condition_int        : std_logic_vector(harc_range);
  ...
  procedure pc_update(
    ...
    signal if_except_condition           : in    std_logic;
    ...
    signal served_if_except_condition    : out   std_logic;
  ...
  begin
    if pc_update_enable          = '1' then
      if taken_branch            = '1' or
        ...
        served_if_except_condition  <= if_except_condition;
      ...
      elsif if_except_condition = '1' then
        served_if_except_condition <= '1';
      end if;
    end if;
  end pc_update;
  --------------------------------------------------------------------------------------
...
begin
  ...
  served_if_except_condition <= served_if_except_condition_int;
  ...
  pc_update_logic : for h in harc_range generate
    ...
    taken_branch_replicated(h) <= '1' when ls_taken_branch  = '1' and (harc_EXEC = h)
                                     ...
                                     else '1' when if_taken_branch  = '1' and (harc_IF_internal = h)
                                     else '0';
    ...
    if_except_condition_replicated(h)  <= '1' when if_except_condition = '1' and (harc_IF_internal = h)
                                     else '0';
    set_except_condition_replicated(h) <= '1' when ls_except_condition_replicated(h) = '1' or ie_except_condition_replicated(h) = '1'or if_except_condition_replicated(h) = '1'
    ...
    begin
      if rst_ni = '0' then 
        ...
        served_if_except_condition_lat(h)       <= served_if_except_condition_int(h);
...
--    pc_updater_comb : process()
    pc_updater_comb : process(
                              pc(h), taken_branch_pc_pending_internal_lat(h), taken_branch_pending_internal_lat(h), served_ie_except_condition_lat(h),served_if_except_condition_lat(h),
                              ...
                              ie_except_condition_replicated(h),if_except_condition_replicated(h), ls_except_condition_replicated(h), set_except_condition_replicated(h), set_mret_condition_replicated(h), 
    ...
    begin
      ...
      served_if_except_condition_int(h)       <= served_if_except_condition_lat(h);
      ...
      if (reset_state(h) = '0') then
        pc_update(
          ...
          irq_pending_internal(h),if_except_condition_replicated(h),
          ...
          pc_update_enable(h),served_if_except_condition_int(h), 
