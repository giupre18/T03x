...
begin
  ...
  -- Memory fault signals
  load_err  <= (data_gnt_i and data_err_i and not(data_we_o_int)) or load_exception_pmp;
  store_err <= (data_gnt_i and data_err_i and data_we_o_int) or store_exception_pmp;
